...
> 🔍 LSTM은 시계열 데이터를 다루는 데 강점이 있어,  
> 시간에 따라 변화하는 운전 패턴을 학습할 수 있습니다.
...
- 이 방식은 환경 요인에 대한 보정을 수행하여, LSTM이 시간 흐름에 따른 **운전 패턴의 연속성**을 학습할 수 있도록 함
